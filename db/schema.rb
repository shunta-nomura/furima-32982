...
ActiveRecord::Schema.define(version: 2020_12_23_183516) do
  ...
  create_table "consumer_places", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["buy_id"], name: "index_consumer_places_on_buy_id"
  end
  ...
  add_foreign_key "consumer_places", "buys"
